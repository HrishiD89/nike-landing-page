...
const Footer = () => {
  return (
    <footer className="max-container">
      <div className="flex justify-between item-start gap-2 flex-wrap max-lg:flex-col">
        <div className="flex flex-col items-start">
          ...
          <div className='flex items-center gap-5 mt-8'>
            {socialMedia.map(socials=>(
              <div  className="flex justify-center items-center w-12 h-12 bg-white rounded-full" key={socials.alt}>
                ...
                <div  className="text-white" key={section}>
                  ...
                  <ul>{
                    section.links.map(link=>(
                      <li className='mt-3 text-white-400 text-base leading-normal font-montserrat hover:text-slate-gray cursor-pointer' key={link.name}>
